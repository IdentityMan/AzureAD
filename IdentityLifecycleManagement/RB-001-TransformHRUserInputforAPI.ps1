...
$script:ScimSchemas = @{
    ...
    "urn:ietf:params:scim:schemas:extension:identityman:1.0:User" = '{"id":"urn:ietf:params:scim:schemas:extension:identityman:1.0:User","name":"EnterpriseUser","description":"Enterprise User","attributes":[{"name":"EA1","type":"string","multiValued":false,"description":"Identifies the value of ExtensionAttribute1.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"EA2","type":"string","multiValued":false,"description":"Identifies the value of ExtensionAttribute2.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"HireDate","type":"string","multiValued":false,"description":"Identifies the HireDate value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"LeaveDate","type":"string","multiValued":false,"description":"Identifies the LeaveDate value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"Initials","type":"string","multiValued":false,"description":"Identifies the Initials value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"GenderPronoun","type":"string","multiValued":false,"description":"Identifies the GenderPronoun value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"UsageLocation","type":"string","multiValued":false,"description":"Identifies the UsageLocation value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"SamAccountName","type":"string","multiValued":false,"description":"Identifies the SamAccountName value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"ParentDistinguishedName","type":"string","multiValued":false,"description":"Identifies the ParentDistinguishedName value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"CountryCode2Letter","type":"string","multiValued":false,"description":"Identifies the CountryCode2Letter value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"},{"name":"CountryCodeNumber","type":"string","multiValued":false,"description":"Identifies the CountryCodeNumber value of the user.","required":false,"caseExact":false,"mutability":"readWrite","returned":"default","uniqueness":"none"}],"meta":{"resourceType":"Schema","location":"/v2/Schemas/urn:ietf:params:scim:schemas:extension:identityman:1.0:User"}}' | ConvertFrom-Json
}

<#
.SYNOPSIS
    Remove Diacritics from specific user values
#>
...
$ScimPayloadOutputResults = Foreach ($user in $AllUsers) {
    #As we don't receive company data from HR, we define a static Company value to make sure lot's of properties are filled.
    $CompanyNameManualInput = "IdentityMan B.V."
    ...
    $UserIDCount = $UserID.length
    If ($UserIDCount -gt 19) {
        $Samaccountname = $UserID.Substring(0,19)
    }
    Else {
    ...
    [PSCustomObject]@{
        WorkerID  = $user.id
        WorkerStatus = $DefaultAccountState
        WorkerType  = $UserType
        FirstName = $user.firstname
        LastName = $user.lastname
...
if (Test-ScimAttributeMapping $AttributeMapping -ScimSchemaNamespace 'urn:ietf:params:scim:schemas:core:2.0:User') {
    $ScimBulkPayload = $ScimPayloadOutputResults | ConvertTo-ScimBulkPayload -ScimSchemaNamespace $ScimSchemaNamespace -AttributeMapping $AttributeMapping
}

# Connect to Az Account with the Managed Identity
Connect-AzAccount -Identity | Out-Null

#Create Storage Blob Container for this specific run
$StorageAccount = Get-AzStorageAccount -Name $StorageAccountName -ResourceGroupName $ResourceGroupName
$StorageContainerName = "iparun-"+$datetimerun
$storageContainer = New-AzStorageContainer -Name $StorageContainerName -Context $StorageAccount.Context

#Set number for first batch
$BatchNr = 1

#Publish each ScimBulkPayload in created storage container as .json file
foreach ($ScimBulkPayload in $ScimBulkPayload) {
    #create file
    $objOutTotalFile = New-TemporaryFile
    $MyRawString = $ScimBulkPayload
    $Utf8NoBomEncoding = New-Object System.Text.UTF8Encoding $False
    [System.IO.File]::WriteAllLines($objOutTotalFile.FullName, $MyRawString, $Utf8NoBomEncoding)
    $filenameblob = "IPA-BulkRequest-"+$BatchNr+"-TransformedHRUserInput.json"
    
    $storeblob = Set-AzStorageBlobContent -Container $StorageContainerName -Context $StorageAccount.Context -File $objOutTotalFile.FullName -Blob $filenameblob -Properties @{"ContentEncoding" = "UTF-8"} 
    
    $BatchNr++
}

#Generate JSON payload output
$params = @{
